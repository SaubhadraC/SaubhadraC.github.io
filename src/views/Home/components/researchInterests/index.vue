<template>
  <div class="px-4 md:px-8 lg:px-20 py-4 bg-[#FFFFFF]">
    <div class="max-w-[1200px] mx-auto">
      <div class="flex flex-wrap justify-between gap-3 p-4">
        <h2 class="text-[#0e141b] tracking-light text-[32px] font-bold leading-tight min-w-72">Area of Interests</h2>
      </div>
      <v-row class="px-4">
...
const iconMap = {
  ...
  Financial_Reporting: "mdi-chart-areaspline-variant",
  "Budgeting_&_Forecasting": "mdi-magnify-expand"
